    ...
    return (
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-semibold text-gray-800">Our services include:</h2>
  
          <div className="space-y-4">
            <h3 className="text-xl font-medium text-gray-800">Custom Cabinetry</h3>
            ...
            <h3 className="text-xl font-medium text-gray-800">Countertops and Backsplashes</h3>
            <p className="text-lg text-gray-700">
            ...
            <h3 className="text-xl font-medium text-gray-800">Appliance Installation</h3>
            <p className="text-lg text-gray-700">
